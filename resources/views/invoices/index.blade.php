    ...
    ================================================================= --}}
        <div class="card">
            ...
            {{-- ============================================================
             FILTER TOOLBAR
        ============================================================= --}}
            <form method="GET" action="{{ route('invoices.index') }}" class="invoice-toolbar">
        ...
        ============================================================= --}}
            @if ($invoices->count() === 0)
                ...
                <div class="empty-state">
                    ...
                    <h3>
                        {{ request()->filled('search') || request()->filled('status') ? 'No invoices found' : 'No invoices yet' }}
                    </h3>
                                    ...
                                    <td>
                                        ...
                                        <div class="actions">
                                            ...
                                            <a href="{{ route('invoices.show', $invoice) }}"
                                                class="action-btn action-view" title="View Invoice">
                                            ...
                                            <a href="{{ route('invoices.download', $invoice) }}"
                                                class="action-btn action-pdf" title="Download PDF">
