        ...
        <div class="page-header">
            <div>
                <div class="clients-heading">
                    ...
                    <span class="clients-heading-text">Registered Clients</span>
                </div>
                <div class="page-subline">
                    <span class="live-tag"><span class="live-dot"></span> {{ $clients->total() }} total</span>
                    <span class="subline-divider">•</span>
                    <span>Manage project owners, stakeholders and client records</span>
                </div>
            </div>
